...
@bot.on_message(filters.command('add_admin') & filters.private & filters.user(Var.ADMINS))
...
@bot.on_message(filters.command('deladmin') & filters.private & filters.user(Var.ADMINS))
